...
/*
  ...
  Plugin URI: http://projects.djekic.netretret/editor_highlight
...
function editor_highlight_echoCSSinclude($filepath) {
    ...
    global $theme_url;
    ?>
    <link rel="stylesheet" href="<?php echo $theme_url.$filepath; ?>.css?version=<?php echo editor_highlight; ?>" />
<?php }
...
function editor_highlight_echoJSinclude($filepath) { 
    global $theme_url;
    ?>
    <script src="<?php echo $theme_url.$jsRoot.$filepath; ?>.js?version=<?php echo editor_highlight; ?>"></script>
<?php }
...
function editor_highlight_action_get_ide() {
    ...
    include($theme_dir . 'admin/editor/editor_highlight_ide.php'); 
    $html = ob_get_contents();
    ob_clean();
    editor_highlight_ajax_response($html);
}
