...
class MyTheme_Customize {
   ...
   public static function register ( $wp_customize ) {
      ...
      $wp_customize->add_setting( 'link_textcolor', //No need to use a SERIALIZED name, as `theme_mod` settings already live under one db record
       ...
       //2. Register new settings to the WP database...
      $wp_customize->add_setting( 'some_image', //No need to use a SERIALIZED name, as `theme_mod` settings already live under one db record
         array(
            'type' => 'theme_mod', //Is this an 'option' or a 'theme_mod'?
            'capability' => 'edit_theme_options' //Optional. Special permissions for accessing this setting.
         ) 
      ...
      $wp_customize->add_control( new WP_Customize_Upload_Control( //Instantiate the color control class
         $wp_customize, //Pass the $wp_customize object (required)
         'mytheme_image', //Set a unique ID for the control
         array(
            'label' => 'Some Image', //Admin-visible name of the control
            ...
            'settings' => 'some_image', //Which setting to load and manipulate (serialized is okay)
            'priority' => 10, //Determines the order this control appears in for the specified section
         ) 
      ) );
